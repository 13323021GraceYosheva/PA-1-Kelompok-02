                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="#" data-toggle="modal" data-target="#modalTambahLayanan" class="btn btn-success btn-sm"><i class="fas fa-plus"></i>Tambah</a>
                            </div>
                                        ...
                                        if ($data != null) {
                                            ...
                                            while ($r = mysqli_fetch_array($data)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" data-toggle="modal" data-target="#modalUpdateKategori-<?= $r['id_layanan'] ?>" class="btn btn-warning btn-sm" id="btn-edit"><i
